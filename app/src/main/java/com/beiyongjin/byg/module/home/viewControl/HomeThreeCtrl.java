...
import com.beiyongjin.byg.module.home.ui.fragment.HomeThreeFrag;
import com.beiyongjin.byg.module.home.viewModel.HomeProgressVM;
import com.beiyongjin.byg.module.home.viewModel.HomeThreeVM;
...
public class HomeThreeCtrl extends BaseRecyclerViewCtrl implements AMapLocationListener {
    ...
    public HomeThreeCtrl(HomeThreeFragBinding binding, int widthPixels) {
        this.binding = binding;
        this.width = widthPixels;
        homeVM = new HomeThreeVM();
            ...
            public void onSuccess(Call<HttpResult<HomeRec>> call, Response<HttpResult<HomeRec>> response) {
                ...
                if (homeRec.isBorrow()) {
                    ...
                    if (dayList.size() == 0 || moneyList.size() == 0 || !Arrays.equals(dayList.toArray(), homeRec.getDayList().toArray())
                            || !Arrays.equals(moneyList.toArray(), homeRec.getCreditList().toArray())) {
                        loanDay.set(homeRec.getMaxDays() + "天");
                        loanMoney.set(ConverterUtil.getInteger(homeRec.getMaxCredit()) + "");
                        calculateMoney = homeRec.getMinCredit();
